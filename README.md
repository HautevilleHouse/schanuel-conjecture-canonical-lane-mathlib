# Schanuel Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/schanuel-conjecture-canonical-lane-mathlib.git
cd schanuel-conjecture-canonical-lane-mathlib
lake exe
lake build
```
